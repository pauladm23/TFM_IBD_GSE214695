...
clone el repo y lo ejecute obtiene los mismos archivos filtrados que se
...
# =============================================================================
# Config: carga de params.yaml y qc_thresholds.yaml 
# =============================================================================
...
OUTPUT_DIR   = Path(PROJECT_ROOT) / PARAMS["paths"]["interim"]["01_qc"]
FIG_DIR      = Path(PROJECT_ROOT) / PARAMS["paths"]["interim"]["01_qc_figures"]
FILT_DIR     = Path(PROJECT_ROOT) / PARAMS["paths"]["interim"]["01_qc_filtered"]
REP_DIR      = Path(PROJECT_ROOT) / PARAMS["paths"]["interim"]["01_qc_reports"]

for d in (OUTPUT_DIR, FIG_DIR, FILT_DIR, REP_DIR):
